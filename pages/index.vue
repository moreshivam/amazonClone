     ...
     <div class="container-fluid browsing-history">
       <div  class="row">
         <div class="col-sm-8 col-8">
           <h1 class="a-size-large a-sapcing-none a-text-normal">All Products</h1>
           ...
           <nuxt-link to="/owner"  class="a-button-history margin-right-10 ">Add a new product</nuxt-link>
        ...
        <div class="history-box">
         ...
         <div class="a-spacing-top-base asin-title">
           <span class="a-text-normal">
             <div class="p13n-sc-trucated"> {{product.title}}</div>
           </span>
         </div>
         <!-- product rating-->
         <div class="row">
